...
func (s *Secret) SaveSecret(userId int, kind string, label string, data string, meta string) error {
	_, err := s.dbpool.Exec(context.Background(), insertSecretSQL, userId, kind, label, data, meta)
	if err != nil {
